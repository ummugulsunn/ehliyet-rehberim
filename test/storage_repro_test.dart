...
void main() {
  test('ExamStorageService isolates exams by ID', () async {
    ...
    if (loaded2 != null) {
      print('CRITICAL FAILURE: Retrieved Exam 2 but expected null. Got: ${loaded2.examId} with answers: ${loaded2.answers}');
    } else {
      print('SUCCESS: Exam 2 is null as expected.');
    }
    
    expect(loaded2, isNull, reason: "Exam 2 should be null but got ${loaded2?.examId}");
  });
}
